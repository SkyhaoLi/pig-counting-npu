...
VIDEO_DIR = SCRIPT_DIR / 'data' / 'datasets' / 'group4'
OUTPUT_BASE = Path('C:/Users/Skyha/Desktop/pig_couter/output/batch_rerun_group4')
...
out_csv = OUTPUT_BASE / 'batch_rerun_group4_results.csv'
