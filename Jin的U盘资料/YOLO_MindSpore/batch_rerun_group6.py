...
VIDEO_DIR = SCRIPT_DIR / 'data' / 'datasets' / 'group6'
OUTPUT_BASE = Path('C:/Users/Skyha/Desktop/pig_couter/output/batch_rerun_group6')
...
out_csv = OUTPUT_BASE / 'batch_rerun_group6_results.csv'
